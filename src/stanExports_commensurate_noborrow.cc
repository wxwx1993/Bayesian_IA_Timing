...
#include "stanExports_commensurate_noborrow.h"

RCPP_MODULE(stan_fit4commensurate_noborrow_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_commensurate_noborrow")
